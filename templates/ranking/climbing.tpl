   ...
   <table border=0 align="center">
        <tr>
            ...
            <td style="border:none;" align="center">
				<h3><strong>Clasament Proba Escalada
			<br />
...
{else}
    <p class="home"><strong>Clasament Proba Escalada - Categoria  {$category.category_name} </strong>  </p>
	<br />
...
{/if}
	...
	<table class="afisare-tabel" style="width: 100% " >
            <tr>
				...
				<th style="width:35%">Nume Participant</th>
				<th style="width:10%">Inaltime</th>
            ...
            {foreach from=$lists item="teams" }
                <tr>
					...
					<td class="numere-tabel">{if $teams.abandon == 1} - {elseif $teams.top == 99} TOP {else} {$teams.top}  {/if}  </td>
